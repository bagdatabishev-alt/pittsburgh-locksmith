  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      try {
        ...
        // Шеберлерді Supabase-тен жүктеу
                  ...
                  {techs.length === 0 ? (
                    ...
                    techs.map((tech) => (
                      <tr key={tech.id} className="hover:bg-slate-800/40 transition">
                        ...
                        <td className="p-4">
                          <span className="bg-amber-500/20 text-amber-400 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase border border-amber-500/30">
