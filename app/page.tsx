...
const DICT = {
  en: {
    ...
    emergencySub: 'Don’t spend time searching. Call us immediately for rapid dispatch.',
  ...
  ru: {
    ...
    emergencySub: 'Не тратьте время на поиски. Позвоните нам для срочного выезда.',
    ...
    placeholders: {
      ...
      '4': 'Пример: Установка кодового замка в офис...',
  ...
  kk: {
    ...
    emergencySub: 'Уақытыңызды іздеуге жұмсамаңыз. Жедел көмек үшін бізге хабарласыңыз.',
